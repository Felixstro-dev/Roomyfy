...
socket.on("connect", () => {
    ...
    usersList.textContent = "Not in a room...";
...
socket.on("chat_image", (data) => {
    ...
    li.innerHTML = `
        ...
        <div class="post__text">
            <img style="image-rendering: pixelated; max-width: 345px" src="${url}">
        </div>
    `;
...
function stringtocolor(str) {
    ...
    if (str === 'INFO') return colors[0];
    if (str === 'COMMANDS') return colors[7]
